...
data(gsm1647847)
data(probeAnnotation21kdatMethUsed$Name)
# load in methyLImp dataset and list of CpG involved in Horvat's epigenetic clock analysis

match1             <- match(probeAnnotation21kdatMethUsed$Name , gsm1647847[,1])
gsm1647847_21k     <- gsm1647847[match1,]
gsm1647847_21k     <- t(gsm1647847_21k[,-1])
# for instance select only CpG for Horvat's epigenetic clock 
